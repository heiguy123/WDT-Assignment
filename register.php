    ...
    <div class="col-md-12 main-section">
        <div class="modal-content">
            ...
            <div class="form-group">
                <input type="text" class="form-control" placeholder="Eg. name@example.com">
            </div>
            <button class="btn col-md-12" type="button" onclick="location.href='verification.html';">Create New Account</button>
