...
<div class="modal-dialog text-center">
    <div class="col-md-12 main-section">
        <div class="modal-content">
            ...
            <div class="row">
                <div class="col-md-6"><h2>Sign In</h2></div>
                <div class="col-md-6 forgot"><a href="forgot.html">Forgot Password?</a></div>
            </div>

            <form action="" class="col-md-12">
            <div class="form-group">
                <input type="text" class="form-control" placeholder="UserID or Email Address">
            </div>
            <div class="form-group">
            ...
            <button class="btn col-md-12" type="button" onclick="location.href='dashboard.html';">Login</button>
            <div class="separator">Create New Account</div> 
            <button class="btn sign-up col-md-12" type="button" onclick="location.href='register.html';">Create New Account</button>
            </form>
        </div>
    </div>
</div>    
