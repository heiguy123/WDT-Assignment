        ...
        <div class="col-md-12 main-section">
            <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 forgot"><a href="forgot.php">Forgot Password?</a></div>
                </div>
                ...
                <form action="" class="col-md-12">
                    ...
                    <button class="btn col-md-12" type="button" onclick="location.href='dashboard.php';">Login</button>
                    <div class="separator">Create New Account</div>
                    <button class="btn sign-up col-md-12" type="button" onclick="location.href='register.php';">Create New Account</button>
                </form>
            </div>
        </div>
    </div>
