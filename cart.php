...
<head>
    ...
    <title>My Restaurant | Cart</title>
   ...
   <div class="card shopping-cart">
        ...
        <div class="card-footer">
            <div class="pull-right" style="margin: 10px">
                ...
                <button onclick='location.href="payment.php";' class="btn btn-success pull-right"
                <?php if (!disableCheckout($_SESSION['cus_row']['cus_id'])) {echo 'disabled';} ?>>Checkout</button>
            </div>
        </div>
    </div>
</div>    
