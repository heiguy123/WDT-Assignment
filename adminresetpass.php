...
if (havesession()) {
    header("location:admindashboard.php"); //if cookie/session is valid, go to dashboard
}
...
<head>
    ...
    <title>My Restaurant | Reset Password</title>
    ...
    <div class="modal-dialog text-center">
        <div class="col-12 main-section">
            <div id="user_info" class="modal-content">
                ...
                <form action="adminresetpass.php" method="POST" class="col-12">
                    <div class="form-group" id="email">
                        <input type="email" name="email" class="form-control" value="<?php echo $_GET['email']; ?>" readonly>
                    </div>
                    <br>
                    ...
                    <div class="form-group" id="re-password">
                        <input type="password" name="re_password" id="re_pass" class="form-control" placeholder="Re-Enter Password">
