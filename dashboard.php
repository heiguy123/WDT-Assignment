...
<body>
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand text-center" href="dashboard.php"><img src="img/res_logo.png" height=50>My Restaurant</a>
        ...
        <div class="container">
            <div class="text-center">
                ...
                <div class="col-md-12">
                    ...
                    <button type="button" onclick="location.href='register.php';" class="btn btn-primary btn-lg">SIGN UP</button>
                </div>
            </div>
        </div>
    </div>
