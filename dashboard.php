...
<nav class="navbar navbar-expand-xl navbar-light bg-light sticky-top">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarlist">
            <ul class="navbar-nav">
                <li class="nav-item" >
                    <a href="dashboard.html" class="nav-link"><img src="img/res_logo.png" height=30>Home</a>
                </li>
                <li class="nav-item" >
                ...
                <li class="nav-item" >
                    <a href="#" class="nav-link"><img src="img/res_logo.png" height=30>Logout</a>
                </li>
            </ul>
        </div>
    </div>
...
<!-- <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
    <div class="container-fluid">
        ...
        <a class="navbar-brand text-center" href="dashboard.html"><img src="img/res_logo.png" height=50>My Restaurant</a>
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
                <a href="#" class="nav-link">Username</a>
            </li>
        </ul>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#cart"> 
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="cart">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item" >
                    <a href="#" class="nav-link"><img src="img/res_logo.png" height=30>Home</a>
                </li>
            </ul>
        </div>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <div class="col-md-12">
                ...
                <button type="button" onclick="location.href='register.html';" class="btn btn-primary btn-lg">SIGN UP</button>
            </div>
        </div>
    </div>
</div>
